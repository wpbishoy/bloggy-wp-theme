...
if ( ! function_exists( 'bloggy_setup' ) ) :
	...
	function bloggy_setup() {
		 ...
		 * If you're building a theme based on Bloggy, use a find and replace
		 * to change 'bloggy' to the name of your theme in all the template files.
		 */
...
define( 'BLOGGY_ACF_PATH', get_stylesheet_directory() . '/inc/acf/' );
define( 'BLOGGY_ACF_URL', get_stylesheet_directory_uri() . '/inc/acf/' );
 ...
 * ACF
 */
require_once BLOGGY_ACF_PATH . 'acf.php';
